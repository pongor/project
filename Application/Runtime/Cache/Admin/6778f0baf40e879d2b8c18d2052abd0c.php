	...
	<body>
		...
		<nav class="navBox">
			...
			<header class="navHead">
				<img class="navLogo" src="/Public/Admin/img/navLogo.png" />
			</header>
			<!--导航栏主体-->
			<section class="nav">
				<!--行业-->
				<ul class="navMain navOption navSelected">
					<a href="<?php echo U('Index/right');?>" target="right">
						<img class="navIcon" src="/Public/Admin/img/navIcon-1.png"/>
						<span>行业</span>
					</a>
				</ul>
				<!--企业-->
				<ul class="navMain navOption">
					<a href="<?php echo U('Company/index');?>" target="right">
						<img class="navIcon" src="/Public/Admin/img/navIcon-2.png"/>
						<span>企业</span>
					</a>
				</ul>
				<!--学生-->
				<ul class="navMain navOption">
					<a href="<?php echo U('Student/index');?>" target="right">
						<img class="navIcon" src="/Public/Admin/img/navIcon-3.png"/>
						<span>学生</span>
					</a>
				</ul>
				<!--判断题-->
				<ul class="navMain navOption">
					<a href="<?php echo U('Judge/index');?>" target="right">
						<img class="navIcon" src="/Public/Admin/img/navIcon-4.png"/>
						<span>判断题</span>
					</a>
				</ul>
				<!--广告位-->
				...
				<!--<ul class="navMain navProduct">
					<a>
						<img class="navIcon" src="/Public/Admin/img/navIcon-1.png"/>
						<span>机会产品</span>
						<img class="navArrowRight" src="/Public/Admin/img/navArrowRight.png"/>
					</a>
				</ul>-->
				<!--二级菜单-->
