			...
			<div class="content">
				<div class="practiceCard">
					...
					<header class="header_practiceCard">
						<div class="banner_practiceCard"><img src="/project<?php echo ($ad["file"]); ?>" /></div>
					...
					<section class="section_practiceCard section_Record">
						<p class="tipText">开始记录你实习期的点点滴滴吧</p>
						<!--添加记录链接-->
						<a href="<?php echo U('Offer/addrecord');?>"><div class="addRecord">
							<img src="/project/Public/Home/img/icon-addRecord.png" />
							<p>添加你的实习记录</p>
						</div></a>
						<!--一条记录-->
						<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$r): $mod = ($i % 2 );++$i;?><div class="box_record">
							...
							<div class="operaBar_record">
								...
								<!--控制操作栏的icon-->
								<img class="iconShowHidd_record showhiddOpera off" src="/project/Public/Home/img/icon-showHidd.png" />
								<!--操作栏-->
								<div class="operaBox_record operaRecord">
									<button class="buttonOpera_record buttonEdit_record" onclick="window.location.href='<?php echo U('Offer/addrecord',array('id'=>$r['id']));?>'">编辑</button><span class="verticalOpera_record"></span>
