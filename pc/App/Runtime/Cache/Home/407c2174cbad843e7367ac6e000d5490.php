						...
						<tbody class="tbody">
							<tr>
								<td class="tb1">
									...
									<div>
										<p class="p1"><?php echo ($info['pdfname']); ?>.PDF</p>
										<p class="p2"><?php echo ($info['pdfsize']); ?>K</p>
									</div>
								</td>
								<td class="tb2"><p><?php echo (date("Y-m-d",$info['uptime'])); ?></p></td>
								<td class="tb3">
									<div>
